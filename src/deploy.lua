...
--data_file = '/tmp/anshuman/kitti.txt'
data_file = '/home/sarthaksharma/predictKps/dataHG/data.txt'
...
--local f = io.open('kitti_kps.txt', 'w')
local f = io.open('/home/sarthaksharma/predictKps/result_KP.txt', 'w')
